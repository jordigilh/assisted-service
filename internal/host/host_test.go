...
var _ = Describe("AutoAssignRole", func() {
	...
	BeforeEach(func() {
		...
		mockOperators.EXPECT().GetCPURequirementForRole(gomock.Any(), gomock.Any()).AnyTimes()
		mockOperators.EXPECT().GetMemoryRequirementForRole(gomock.Any(), gomock.Any()).AnyTimes()
	})
